...
public class PriorityThread extends Thread {
	...
	public static void main(String[] args) {
		...
		System.out.println("::"+p1.getThreadName()+"tread의 우선 순위 : "+p1.getPriority());
		System.out.println("::"+p2.getThreadName()+"tread의 우선 순위 : "+p2.getPriority());
		System.out.println("::"+p3.getThreadName()+"tread의 우선 순위 : "+p3.getPriority());
	}
